...
SET RELEASE_VERSION=0.43.0
SET TAG_NAME=RELEASE_0.43.0
SET MAINTENANCE_VERSION=0.43.1-SNAPSHOT
SET MAINTENANCE_BRANCH_NAME=MAINTENANCE_0.43
SET NEXT_DEVELOPMENT_VERSION=0.44.0-SNAPSHOT
